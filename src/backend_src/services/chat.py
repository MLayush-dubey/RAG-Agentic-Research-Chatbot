...
def get_answer(chat_history: list) -> dict:
    ...
    last_user_message = chat_history[-1]  #in the chat history, the last message will go to this
    ...
    history_without_last = chat_history[:-1]  #creates new list without keeping the last value
    input_data = {

...
#this is basically the document retrieval part of RAG
...
def rag_query_tool(query: str) -> dict:
    ...
    query_engine = index.as_query_engine(similarity_top_k=3) #num of similar docs

...
qa_agent = Agent(
    ...
    backstory="You are a knowledgeable AI/ML researcher who has spent years helping people find clarity in large"
              " document collections specifically research papers. You specialize in surfacing the most relevant evidence and turning it into clear,"
